...
export default function LoginModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 text-slate-800 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative">
        ...
        <div className="p-6 bg-slate-50 border-b border-slate-200 text-center">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-500 to-teal-400 flex items-center justify-center mx-auto mb-3 shadow-lg shadow-emerald-500/20">
            <Store className="w-6 h-6 text-white font-bold" />
          </div>
        ...
        {currentUser ? (
          <div className="p-6 space-y-5">
            <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center gap-3">
              <div className="p-3 rounded-xl bg-emerald-100 text-emerald-600 font-bold">
                <UserIcon className="w-6 h-6" />
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-1.5 text-xs text-emerald-600 font-bold mb-0.5">
            ...
            <div className="space-y-2">
              {onLogout && (
                <button
                  ...
                  className="cursor-pointer w-full py-3 rounded-xl bg-rose-50 text-rose-600 border border-rose-200 hover:bg-rose-100 font-extrabold text-sm flex items-center justify-center gap-2 transition-all active:scale-95"
                >
              ...
              {onClose && (
                <button
                  type="button"
                  onClick={onClose}
                  className="cursor-pointer w-full py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs transition-all active:scale-95"
                >
